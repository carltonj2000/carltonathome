...
import { up as up002, down as down002 } from "./migrations/migration002";
...
const uds: Array<MigrateUdI> = [
  { migrationNo: 1, up: up001, down: down001 },
  { migrationNo: 2, up: up002, down: down002 },
];
